    ...
    <>
      <div id='description'>
        <div className='description  pb-4 px-[3%] lg:px-0 w-full border-b-[2px] '>
          <div className='p-[2%] pl-0 lg:text-[22px] text-[18px] font-semibold'>
            {video.Title}
          </div>
          <div className='reaction flex flex-col justify-between  space-y-2  text-white'>
            <div className='vuesAndDate flex flex-row space-x-2'>
              <div className='vues  text-black space-x-1 lg:text-base text-[13px] flex flex-row justify-center'></div>
            </div>
            <div className='vuesAndDate flex flex-row space-x-2'>
            ...
            <div className='reaction flex flex-row space-x-4 bg-gray-200 w-max px-2 rounded-lg'>
              <div
                className={`jaime hover:text-blue-500  cursor-pointer   p-2 rounded-3xl h-[45px] text-black flex lg:flex-row flex-col justify-center items-center lg:space-x-2 lg:text-[18px] font-semibold lg:text-base text-[13px]`}
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  onClick={handleButtonAimeClick}
                  fill='none'
                  viewBox='0 0 24 24'
                  strokeWidth='1.5'
                  stroke='currentColor'
                  style={{ color: buttonAimeColor }}
                  className={` ${yesColor}  lg:w-6 lg:h-6 w-4 h-4 cursor-pointer `}
                >
                  <path
                    strokeLinecap='round'
              ...
              <div
                className={`jaimepas hover:text-blue-500  cursor-pointer  p-2 rounded-3xl h-[45px] text-black flex lg:flex-row justify-center items-center  lg:space-x-2 lg:text-[18px] lg:text-base text-[13px] font-semibold flex-col`}
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  onClick={handleButtonAimepasClick}
                  fill='none'
                  viewBox='0 0 24 24'
                  strokeWidth='1.5'
                  stroke='currentColor'
                  style={{ color: buttonAimepasColor }}
                  className={`${noColor} lg:w-6 lg:h-6 w-4 h-4 cursor-pointer`}
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
              ...
              <div
                title='Share'
                className='partager hover:text-blue-500 cursor-pointer  bg-gray-200 p-2 rounded-3xl h-[45px] text-black flex lg:flex-row justify-center items-center lg:space-x-2 text-[18px] font-semibold flex-col'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  ...
                  strokeWidth='1.5'
                  stroke='currentColor'
                  className='hover:text-blue-500  lg:w-6 lg:h-6 w-4 h-4 cursor-pointer'
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
              ...
              <div
                ...
                className='telecharger p-3 h-[45px] text-white bg-blue-500 hover:bg-blue-700 rounded-[50%] lg:text-base text-[13px] duration-300 '
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
        ...
        <div className='profil  flex flex-row justify-between lg:px-0 px-[3%] items-center  '>
          ...
          {video.User === auto.ID ? null : (
            <SubBtn handleSub={handleSub} abonne={abonne} />
          )}
        </div>
      </div>
    </>
